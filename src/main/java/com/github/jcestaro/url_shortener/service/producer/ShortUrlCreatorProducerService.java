...
@Service
public class ShortUrlCreatorProducerService extends ProducerTemplate<String, Response<UrlMapping>> {
    ...
    @Override
    protected ReplyingKafkaTemplate<String, String, Response<UrlMapping>> getReplyingKafkaTemplate() {
